...
public class gonggao_servlet extends HttpServlet
{
	...
	public void gonggaoManaQian(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		List gonggaoList=new ArrayList();
		String sql="select * from t_gonggao";
		Object[] params={};
		...
		req.setAttribute("gonggaoList", gonggaoList);
		req.getRequestDispatcher("/qiantai/gonggao/gonggaoListQian.jsp").forward(req, res);
	}
